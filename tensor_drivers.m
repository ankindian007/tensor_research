...
[pr1, pr2, tot_all, tot_new] = result_evaluation(l_type,fac,r,P_50,T_log,T_log_test); 
results_50 = [results_50; r fac l_type pr1 pr2 tot_all tot_new];
r = 21540; fac = 50; l_type = 1;
[pr1, pr2, tot_all, tot_new] = result_evaluation(l_type,fac,r,P_10,T_log,T_log_test); 
results_50 = [results_50; r fac l_type pr1 pr2 tot_all tot_new];
r = 21540; fac = 50; l_type = 2;
[pr1, pr2, tot_all, tot_new] = result_evaluation(l_type,fac,r,P_10,T_log,T_log_test); 
results_50 = [results_50; r fac l_type pr1 pr2 tot_all tot_new];
...
r = 100; fac = 50; l_type = 1;
[pr1, pr2, tot_test_links] = result_evaluation(l_type,fac,r,P_50,T_log,T_log_test); 
results_50 = [results_50; r fac l_type pr1 pr2 tot_test_links];
r = 1000; fac = 50; l_type = 1;
[pr1, pr2, tot_test_links] = result_evaluation(l_type,fac,r,P_50,T_log,T_log_test); 
results_50 = [results_50; r fac l_type pr1 pr2 tot_test_links];
r = 3000; fac = 50; l_type = 1;
[pr1, pr2, tot_test_links] = result_evaluation(l_type,fac,r,P_50,T_log,T_log_test); 
results_50 = [results_50; r fac l_type pr1 pr2 tot_test_links];
r = 10000; fac = 50; l_type = 1;
[pr1, pr2, tot_test_links] = result_evaluation(l_type,fac,r,P_50,T_log,T_log_test); 
